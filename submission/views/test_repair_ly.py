...
def my_repair(stu_code, pro_id):
    ...
    for row_template in rows_template:
        ...
        tmp_template_name = str(row_template[0]) + '.c'
        ...
        clara_repair(ins=[list(template_ins)], code_names=[tmp_template_name, tmp_file_name], cmd='repair')
